...
public:
    ...
    void display()
    {
        ...
        for(int i=0;i<5;i++)
        {
            if(i==2)
            {
                cout<<"|_\x1b[4m"<<ans1[0][c]<<"\x1b[0m_|_\x1b[4m \x1b[0m_";
            }
            else{
                cout<<"|_\x1b[4m"<<ans1[0][c]<<"\x1b[0m_|\x1b[4m  \x1b[0m_";
            }
            c+=2;
        }
        cout<<"_\x1b[4m  \x1b[0m_|_\x1b[4m"<<ans1[0][13]<<"\x1b[0m_|"<<endl;

        //1st row
        for(int i=0;i<7;i++)
        {
            cout<<"|_\x1b[4m"<<ans1[1][i]<<"\x1b[0m_";
        }
        ...
        for(int i=0;i<5;i++)
        {
            if(i==0 || i==2 || i==3 || i==4)
            {
                cout<<"|_\x1b[4m"<<ans1[2][c]<<"\x1b[0m_|_\x1b[4m  \x1b[0m";
            }
            else{
                cout<<"|_\x1b[4m"<<ans1[2][c]<<"\x1b[0m_|\t";
            }
            c+=2;
        }
        cout<<"_\x1b[4m  \x1b[0m_|_\x1b[4m"<<ans1[2][13]<<"\x1b[0m_|"<<endl;
        ...
        for(int i=0;i<4;i++)
        {
            cout<<"|_\x1b[4m"<<ans1[3][c]<<"\x1b[0m_";
            if(i==3)
            {
        ...
        for(int i=0;i<7;i++)
        {
            if(i==1)
            {
                ...
                cout<<"|_\x1b[4m"<<ans1[4][c]<<"\x1b[0m_";
            }
            c++;
        }
        cout<<"|";
        c++;
        cout<<"_\x1b[4m \x1b[0m_|_\x1b[4m"<<ans1[4][c]<<"\x1b[0m_|_\x1b[4m \x1b[0m__\x1b[4m \x1b[0m__|"<<"_\x1b[4m"<<ans1[4][13]<<"\x1b[0m_|"<<endl;
        ...
        for(int i=0;i<5;i++)
        {
            if(i==0)
            {
                ...
                cout<<"|_\x1b[4m"<<ans1[5][c]<<"\x1b[0m_";
            }
            if(i==4)
            {
                cout<<"|";
        ...
        cout<<"|_\x1b[4m"<<ans1[6][c]<<"\x1b[0m_|_\x1b[4m \x1b[0m_|_\x1b[4m13\x1b[0m|";
        c=5;
        for(int i=0;i<6;i++)
        {
            cout<<"_\x1b[4m"<<ans1[6][c]<<"\x1b[0m_|";
            c++;
        }
        cout<<"_\x1b[4m \x1b[0m_|_\x1b[4m18\x1b[0m|_\x1b[4m"<<ans1[6][13]<<"\x1b[0m_|";
        ...
        for(int i=0;i<13;i++)
        {
            ...
            else if(i==4 || i==6)
            {
                ...
                cout<<"_\x1b[4m"<<ans1[7][c]<<"\x1b[0m_|";
            }
            c++;
        }
        ...
        for(int i=0;i<9;i++)
        {
            if(i==2)
            {
                ...
                cout<<"_\x1b[4m"<<ans1[8][c]<<"\x1b[0m_|";
            }
            c++;
        }
        cout<<"_\x1b[4m21\x1b[0m|\x1b[4m  \x1b[0m_|_\x1b[4m"<<ans1[8][12]<<"\x1b[0m_|_\x1b[4m \x1b[0m_"<<endl;
        ...
        for(int i=0;i<14;i++)
        {
            ...
            else if(i==9)
            {
                ...
                cout<<"_\x1b[4m"<<ans1[9][c]<<"\x1b[0m_|";
            }
            c++;
        }
        cout<<endl;
        ...
        for(int i=0;i<13;i++)
        {
            ...
            else if(i==5)
            {
                ...
                cout<<"_\x1b[4m"<<ans1[10][c]<<"\x1b[0m_|";
            }
            c++;
        }
        cout<<endl;
        ...
        for(int i=0;i<13;i++)
        {
            ...
            else if(i==9)
            {
                ...
                cout<<"_\x1b[4m"<<ans1[11][c]<<"\x1b[0m_|";
            }
            c++;
        }
        cout<<endl;
        ...
        for(int i=0;i<13;i++)
        {
            ...
            else if(i==2 || i==3 || i==4 || i==5)
            {
                ...
                cout<<"_\x1b[4m"<<ans1[12][c]<<"\x1b[0m_|";
            }
            c++;
        }
        ...
        for(int i=0;i<14;i++)
        {
            ...
            else if(i==7)
            {
                ...
                cout<<"_\x1b[4m"<<ans1[13][c]<<"\x1b[0m_|";
            }
            c++;
        }
        cout<<endl;
